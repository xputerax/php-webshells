...
<tr>
<td><input type=radio name=type value="TINYINT" <?php if ($type ==
"tinyint") {
        echo "checked";
    } ?>>TINYINT (-128 ~ 127)</td>
...
<tr>
<td><input type=radio name=type value="SMALLINT" <?php if ($type ==
"smallint"
) {
        echo "checked";
...
<tr>
<td><input type=radio name=type value="MEDIUMINT" <?php if ($type ==
"mediumint") {
        echo "checked";
...
<tr>
<td><input type=radio name=type value="DECIMAL" <?php if ($type ==
"decimal") {
        echo "checked";
    } ?>>DECIMAL(NUMERIC)</td>
<td align=center>O</td>
...
<tr>
<td><input type=radio name=type value="DATETIME" <?php if ($type ==
"datetime"
) {
        echo "checked";
...
<tr>
<td><input type=radio name=type value="TIMESTAMP" <?php if ($type ==
"timestamp") {
        echo "checked";
...
<tr>
<td><input type=radio name=type value="VARCHAR" <?php if ($type ==
"varchar") {
        echo "checked";
    } ?>>VARCHAR</td>
<td align=center>O</td>
...
<tr>
<td><input type=radio name=type value="TINYTEXT" <?php if ($type ==
"tinytext"
) {
        echo "checked";
    } ?>>TINYTEXT (0 ~ 255)</td>
...
<tr>
<td><input type=radio name=type value="MEDIUMTEXT" <?php if ($type ==
"mediumtext") {
        echo "checked";
...
<tr>
<td><input type=radio name=type value="LONGTEXT" <?php if ($type ==
"longtext"
) {
        echo "checked";
...
<tr>
<td><input type=radio name=type value="TINYBLOB" <?php if ($type ==
"tinyblob"
) {
        echo "checked";
    } ?>>TINYBLOB (0 ~ 255)</td>
...
<tr>
<td><input type=radio name=type value="MEDIUMBLOB" <?php if ($type ==
"mediumblob") {
        echo "checked";
...
<tr>
<td><input type=radio name=type value="LONGBLOB" <?php if ($type ==
"longblob"
) {
        echo "checked";
...
value="AUTO_INCREMENT" <?php if ($fieldextra == "auto_increment") {
        echo
"checked";
    } ?>></td>
